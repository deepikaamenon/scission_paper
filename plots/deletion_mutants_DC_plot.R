...
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/SC/delinp52/2017_10_17/inp52_del_3132_9a/tracks.Rdata"))->rvs_delinp52_notrans
...
#get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/inp52_del/2019_10_31/3903_inp52del_3132/"))->abp3132_notrans_delinp51

#get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/diploids/2018_02_21/3132x3131/rvsgfp2x_W2.Rdata"))->abp_notrans_2x
#get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/diploids/2018_02_21/559x521"))->abp_notrans_1x
...
#sla1_delinp51<-gen.data(sla1_delinp51_notrans,transformation_template,n=NA,sn=NA, zero=0, t0=t0_abp823_delinp51) 
...
#rvs_delinp52<-gen.data(rvs_delinp52_notrans,transformation_template,n=NA,sn=NA, zero=0, t0=t0_abp3132_delinp52)
...
#t_sla1_del51[,"t"]=sla1_del51[,"t"]-sla1_del51[1,"t"]
#t_sla1_del52[,"t"]=sla1_del52[,"t"]-sla1_del52[1,"t"]

#t_rvs=rvs[,"t"]-rvs[1,"t"]
#t_2832=rvs_wt2832[,"t"]-rvs_wt2832[1,"t"]
#t_3131=rvs_wt3131[,"t"]-rvs_wt3131[1,"t"]

#t_delvps=delvps_rvs[,"t"]-delvps_rvs[1,"t"]
#t_del51=rvs_del51[,"t"]-rvs_del51[1,"t"]
#t_del52=rvs_del52[,"t"]-rvs_del52[1,"t"]
...
#plot them
pdf("check_mutantDC_wt_allfalse_rvsdelvps_wtrvs3x.pdf")
...
legend("topleft",c("WT-sla1-141", "abp141-w2_int"),lty=1,col=c("#660000", "#006600"),bty='n', cex=0.75)
...
legend("topleft",c("WT-sla1-823", "abp823-w2_int"),lty=1,col=c("#660000", "#006600"),bty='n', cex=0.75)
...
myplot(abp_rvs[,"t"],mnorm(abp_rvs[,"fi"])*200,abp_rvs[,"t.err"],abp_rvs[,"fi.err"],line.col="#660000",xlab="Time (s)",ylab="Inward movement (nm)",line.lwd=3,deltat=0.25,xlim=c(-30,10),ylim=c(-10,200))
...
myplot(rvs_delinp51[,"t"],rvs_delinp51[,"x"]-x_rvsdel51,rvs_delinp51[,"t.err"],rvs_delinp51[,"x.err"],line.col="#CC66FF",hold_on=TRUE,line.lwd=3,deltat=0.25)

legend("topleft",c("WT-sla1", "delVps1-sla1"),lty=1,col=c("#660000", "#006600"),bty='n', cex=0.75)

#abp1 fl.int vps del

myplot(abp_wt[,"t"],mnorm(abp_wt[,"fi"]),abp_wt[,"t.err"],abp_wt[,"fi.err"],line.col="#FFFFFF",xlab="Time (s)",ylab="Fl.Intensity (a.u)",line.lwd=3,deltat=0.45,xlim=c(-30,10),ylim=c(0,1.1))
...
myplot(abp_rvs_delinp51[,"t"],mnorm(abp_rvs_delinp51[,"fi"]),abp_rvs_delinp51[,"t.err"],abp_rvs_delinp51[,"fi.err"],line.col="#CC66FF",hold_on=TRUE,line.lwd=3,deltat=0.25)

legend("topleft",c("WT-sla1-abpW2", "delVps1-sla1-abpw2"),lty=1,col=c("#660000", "#006600"),bty='n', cex=0.75)
title(main="abp1 dl. intensity", sub="x axis 0 at abp_w2 max.")
...
myplot(abp_sla1_delinp52[,"t"],mnorm(abp_sla1_delinp52[,"fi"])*200,abp_sla1_delinp52[,"t.err"],abp_sla1_delinp52[,"fi.err"],line.col="#0066FF",hold_on=TRUE,line.lwd=3,deltat=0.25)

#myplot(sla1_823[,"t"],sla1_823[,"x"]-xsla823,sla1_823[,"t.err"],sla1_823[,"x.err"],line.col="#FF6666",hold_on=TRUE,line.lwd=3,deltat=0.25)
legend("topleft",c("WT-sla1", "delinp52-sla1"),lty=1,col=c("#660000", "#006600"),bty='n', cex=0.75)
...
myplot(abp_sla1_delinp52[,"t"],mnorm(abp_sla1_delinp52[,"fi"]),abp_sla1_delinp52[,"t.err"],abp_sla1_delinp52[,"fi.err"],line.col="#0066FF",hold_on=TRUE,line.lwd=3,deltat=0.25)
