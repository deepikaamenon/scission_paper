...
#plot them
########################################################################################################
pdf("comparison_sla1_haploid_rvsdelfig1.pdf")
...
pdf("rvs_all_haploid_rvsmax.pdf")
myplot(t_rvs_dup_d,rvs_dup_d[,"x"]-x_rvs_dup_d,rvs_dup_d[,"t.err"],rvs_dup_d[,"x.err"],line.col="#FFFFFF",xlab="Time (s)",ylab="Inward movement (nm)",line.lwd=3,deltat=0.25,xlim=c(-10,10),ylim=c(-25,150))
