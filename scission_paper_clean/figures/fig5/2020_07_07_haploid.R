...
#abp intensity
myplot(abp_sla1_2xBAR[,"t"],abp_sla1_2xBAR[,"n"],abp_sla1_2xBAR[,"t.err"],abp_sla1_2xBAR[,"n.err"],line.col="#CC0066",xlab="time(s)",ylab="# molecules",xlim=c(-20,20), ylim=c(0,500))
...
myplot(abp_sla1_2x[,"t"],abp_sla1_2x[,"n"],abp_sla1_2x[,"t.err"],abp_sla1_2x[,"n.err"],line.col="#660099",hold_on=TRUE,line.lwd=3,deltat=0.45)

legend("topleft",c("abp1_sla1 2xRvs","abp1_sla1 2xBAR"),lty=1,col=c("#CC0066", "#660099" ),bty='n', cex=0.75)
dev.off()
