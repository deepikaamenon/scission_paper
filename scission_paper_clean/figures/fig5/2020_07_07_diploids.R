...
source("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Doc/align_tracks.R")
#cols<-brewer.pal(9, "PuBu")

#RVS diploids from SC data
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/diploid/Rvs167/2017_07_07/4dx5b/tracks.Rdata"))->Rvs4x
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/diploid/Rvs167/2017_07_07/2832x3132/tracks.Rdata"))->Rvs2x
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/diploid/Rvs167/2017_07_07/529x551/motile.Rdata"))->Rvs1x

#Sla1 from SC data

#get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/WT/sla1egfp/2017_06_12_823/tracks_blue.Rdata"))->wtsla12017
#get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/Rvsduplication/Sla1/2017_06_12_161d100_167d100_823_5a/tracks_green.Rdata"))->rvsdup_sla1
...
#sla1 from haploids
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/delrvs167/delrvs_sla1_0531/wo_treatment/analysis_1_2p/tracks.Rdata"))->delrvs_sla1_notrans
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/SC/rvs_delsh3/rvs167_delsh3_sla1_egfp/2015_04_02/tracks.Rdata"))->delsh3_sla1_notrans
#2104_11_05/tracks.Rdata
print("ok")

#abp from alignment of Rvs SC to Rvs-abp DC _ W2.data
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/DC/diploids/2018_02_21/4xrvs/rvsgfpdup4x_W2.Rdata"))->abp_notrans_4x
get(load("/Volumes/s-biochem-kaksonen/Deepika/data_desktop/Tracking/DC/diploids/2018_02_21/3132x3131/rvsgfp2x_W2.Rdata"))->abp_notrans_2x
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/diploids/2018_02_21/559x521/rvsgfp1x_2020_04_29_W2.Rdata"))->abp_notrans_1x
...
time(Rvs4x$ts)[which(Rvs4x$ts[,"mean_sFI"]==max(Rvs4x$ts[,"mean_sFI"],na.rm=TRUE))]->t0_rvs_4x
...
rvs4x<-gen.data(Rvs4x,transformation_template,n=63.7 ,sn=5.5,t0=t0_rvs_4x)
rvs2x<-gen.data(Rvs2x,transformation_template,n=55.9,sn=4.6, t0=t0_rvs_2x)
rvs1x<-gen.data(Rvs1x,transformation_template,n=44.8 ,sn=4.7,t0=t0_rvs_1x)
...
pdf("Rvsdup_DC_alignedRvsmax5.pdf")
#_4: with abp1mch data
#_5 with sla1 vs abp1 movement
...
myplot(sla14x[,"t"]+5,sla14x[,"x"]-sla14x_x0,sla14x[,"t.err"],sla14x[,"x.err"],line.col="#82dad7",hold_on=TRUE,line.lwd=3,deltat=0.25)
myplot(sla12x[,"t"]+5,sla12x[,"x"]-sla12x_x0,sla12x[,"t.err"],sla12x[,"x.err"],line.col="#000033",hold_on=TRUE,line.lwd=3,deltat=0.25)

myplot(t_diploid1x-17.3,sla1diploid_rvs1x[,"x"]-x_sla1diploid_rvs1x,sla1diploid_rvs1x[,"t.err"],sla1diploid_rvs1x[,"x.err"],line.col="#000000",hold_on=TRUE,line.lwd=3,deltat=0.25)
#myplot(sla12x_2xsla1[,"t"]+19.5,sla12x_2xsla1[,"x"]-sla12x_2xsla1_x0,sla12x_2xsla1[,"t.err"],sla12x_2xsla1[,"x.err"],line.col="#000066",hold_on=TRUE,line.lwd=3,deltat=0.25)


legend("topleft",c("Rvs4x", "Rvs2x", "Rvs1x", "sla14x","sla12x", "sla12x 1/2 sla1 tagged","sla11x"),lty=1,col=c('#003300','#669900',"#A69732","#82dad7", "#000033","#000066","#000000" ),bty='n', cex=0.75)
title(main="Rvs in diploids", sub=" t0rvs=rvs max")
...
myplot(abpsla14x[,"t"],abpsla14x[,"n"],abpsla14x[,"t.err"],abpsla14x[,"n.err"],line.col="#0000ee",xlab="Time (s)",ylab="Fl.Intensity (a.u)",line.lwd=3,deltat=0.45,xlim=c(-20,10),ylim=c(0,400))
myplot(sla14x[,"t"],sla14x[,"n"],sla14x[,"t.err"],sla14x[,"n.err"],line.col="#82dad7",hold_on=TRUE,line.lwd=3,deltat=0.45)
myplot(rvs4x[,"t"],rvs4x[,"n"],rvs4x[,"t.err"],rvs4x[,"n.err"],line.col="#003300",hold_on=TRUE,line.lwd=3,deltat=0.45)
myplot(abp4x[,"t"],abp4x[,"n"],abp4x[,"t.err"],abp4x[,"n.err"],line.col="#990000",hold_on=TRUE, line.lwd=3,deltat=0.45)
myplot(sla14x[,"t"],sla14x[,"x"]-sla14x_x0,sla14x[,"t.err"],sla14x[,"x.err"],line.col="#82daee",hold_on=TRUE,line.lwd=3,deltat=0.45)
...
myplot(abpsla12x[,"t"],abpsla12x[,"n"],abpsla12x[,"t.err"],abpsla12x[,"n.err"],line.col="#0000ee",xlab="Time (s)",ylab="Fl.Intensity (a.u)",line.lwd=3,deltat=0.45,xlim=c(-20,10),ylim=c(0,400))
myplot(sla12x[,"t"],sla12x[,"n"],sla12x[,"t.err"],sla12x[,"n.err"],line.col="#000033",hold_on=TRUE,line.lwd=3,deltat=0.45)
myplot(rvs2x[,"t"],rvs2x[,"n"],rvs2x[,"t.err"],rvs2x[,"n.err"],line.col="#669900",hold_on=TRUE,line.lwd=3,deltat=0.45)
myplot(abp2x[,"t"],abp2x[,"n"],abp2x[,"t.err"],abp2x[,"n.err"],line.col="#CC0066",hold_on=TRUE,line.lwd=3,deltat=0.45)
myplot(sla12x[,"t"],sla12x[,"x"]-sla12x_x0,sla12x[,"t.err"],sla12x[,"x.err"],line.col="#000066",hold_on=TRUE,line.lwd=3,deltat=0.45)
