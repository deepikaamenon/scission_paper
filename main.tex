...
In order to further probe the contribution of the Rvs167 SH3 domain to endocytosis, we compared dynamics of Sla1, as well as Rvs167 and BAR-GPA centroids (FIg4a), and quantified the number of molecules recruited to endocytic sites (Fig4b). Recruitment of BAR is reduced to half that of Rvs167 (FIg4c). Cytoplasmic concentration of Rvs167 and BAR are not different (Fig4 supplement). The inward jump of BAR is less than that of full-length Rvs167 (Fig.4A). 
