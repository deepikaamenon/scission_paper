...
\begin{figure}[h]
	...
	\caption{\textbf {Endocytic dynamics in BAR-GPA cells} 
		A,B: Averaged centroid positions aligned in x axis so that time=0(s) is the peak of fluorescent intensity of Abp1 in respective strains. Centroids are aligned in y axis so that Sla1 begins at y=0 (nm), and Rvs167 and Rvs167textit{$\Delta$sh3} positions are determined with respect to Sla1 centoids. C,D: Numbers of molecules of in WT and \textit{rvs167$\Delta$sh3} cells, aligned so that time=0(s) is the maximum of fluorescent intensity of Abp1 in the corresponding strains.}
	\label{delsh3}
\end{figure}
