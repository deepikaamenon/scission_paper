...
Centroid movement of Sla1-eGFP in wild-type cells shows a linear movement to about 150nm. Sla1 movement in \textit{vps1$\Delta$} cells has the same amount of inward movement to about 150nm, and has the same rate as in wild-type cells. This indicates that plasma membrane dynamics remain uninfluenced by the absence of recruitment of Vps1. 
