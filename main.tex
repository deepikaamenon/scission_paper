...
Centroid movement of Sla1-eGFP in WT cells is linear to about 140nm. Sla1 movement in \textit{vps1$\Delta$} cells has the same magnitude of inward movement. In spite of slight differences in the rates of movment, the total inward movment- and so the depth of endocytic invagination- does not change. 
