...
We tested the interaction by studying the localization of full0length Rvs167 in cells with one of these proteins deleted, and treated with Las17 to reproduce the situation in which BAR-curvature interaction is removed. 
As seen in (some figure), deletion of Las17 in combination with LatA treatment does not remove the localization of Rvs167. 
