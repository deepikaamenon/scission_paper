...
In order to further probe the contribution of the Rvs167 SH3 domain to endocytosis, we compared dynamics of Sla1, as well as Rvs167 and BAR-GPA centroids (Fig4a). We also quantified the number of Abp1 and Rvs molecules recruited to endocytic sites (Fig4b). Movement of the coat protein Sla1 is reduced in BAR-GPA cells (Fig4a). Sla1 moves into the cytoplasm approximately 60nm instead of the 140nm found in WT invaginations. Tubular invaginations are formed in BAR cells, and qualitatively resemble that in WT cells, as seen by CLEM (Fig.4 supplement). The inward jump of BAR-GPA is less than that of full-length Rvs167 (Fig.4a). Recruitment of BAR is reduced to half that of Rvs167 (Fig4c), although cytoplasmic concentration of Rvs167 and BAR are not different (Fig4 supplement). 

Abp1 recruitment in BAR cells is reduced to 50\% of WT recruitment, to 172.6±12.9 from 347±30.6 molecules in WT (Fig.3.4C). This data shows that loss of the SH3 domain is detrimental to the progress of endocytic sites.
