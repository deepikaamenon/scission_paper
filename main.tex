...
Plots in Fig1.D-F are aligned in the x axis so that Time=0 (sec) corresponds to the maximum fluorescent intensity of the Abp1 centroid. Along the y
 axis, the centroid positions are aligned so that they begin at y=0 (nm).
