...
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/SC/WT/sla1egfp/wo_treat/tracks2.Rdata"))->WTsla1
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/SC/WT/Abp1/2017_04_10_123/tracks.Rdata"))->WTabp1

#orig data set for aligned_newabp2018_removedboth_newdelsh4.pdf
...
##WT
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/wt/sla10822/aligment_DMabpDC/alignment_GenSla1_wHDabp/sla1wt_141abpgfp_2021_mytrasf.Rdata"))->sla1_transf
#get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/DC/wt/sla10822/aligment_DMabpDC/alignment_GenSla1_wGenabp/sla1wt_141gen_abpegfp_mytrasf.Rdata"))->sla1_transf
...
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/SC/Abp1-mCH/alignments/abpmch_Rvs2832_2021_05_18_e_mytrasf.Rdata"))->rvs_trasf
...
rvs_wt_no<-gen.data(WTrvs,rvs_trasf,n=53.2,sn=5.2, zero=0,  t0=my_t0)

abp1<-gen.data(WTabp1,transformation_template,NA, NA, t0=my_t0, zero=0)
abp1_no<-gen.data(WTabp1,transformation_template,n=344.8,sn=27.8,rescale.n=1, t0=my_t0, zero=0)
...
abp_delsh3_no<-gen.data(delsh3_abp,transformation_template,n=243.5,sn=24.6,rescale.n=1,t0=my_t0_delsh3, zero=0)
...
x1<-mean(sla1_wt[1:50,"x"])
x_delsh3<-median(sla1_delsh3[1:110,"x"])

#plot them
pdf("aligned_newabp2018_removedboth_newdelsh5_2021.pdf")

myplot(abp1[,"t"],abp1[,"x"]-x1,abp1[,"t.err"],abp1[,"x.err"],line.col="#FF3399",xlab="Time (s)",ylab="Inward movement (nm)",line.lwd=3,deltat=0.25,xlim=c(-30,10),ylim=c(-150,200))
...
#abp numbers
#myplot(abp1_no[,"t"],abp1_no[,"n"],abp1_no[,"t.err"],abp1_no[,"n.err"],line.col="#FF3399",xlab="Time (s)",ylab="Fl.Intensity (a.u)",line.lwd=3,deltat=0.25,xlim=c(-25,15),ylim=c(0,1.1))
#myplot(abp_delsh3_no[,"t"],abp_delsh3_no[,"n"],abp_delsh3_no[,"t.err"],abp_delsh3_no[,"n.err"],line.col="#FF0033",hold_on=TRUE,line.lwd=3,deltat=0.25)
