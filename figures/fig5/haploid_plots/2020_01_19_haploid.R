...
get(load("/Users/deepikaa/Desktop/data_desktop/Tracking/SC/Abp1-mCH/alignments_haploid/rvsdelsh3_sla1_3826_mytrasf.Rdata"))->sla13826_transf
...
#sla823<-gen.data(wtsla12017,sla1823_transf,n=NA,sn=NA)
...
sla1_141geneva<-gen.data(wtsla1_141geneva,sla1823_transf,n=NA,sn=NA,t0=t0_abpmch_1xRvs_sla1)
sla1_hd<-gen.data(wtsla1_hd,sla1823_transf,n=NA,sn=NA,t0=t0_abpmch_1xRvs_sla1)
#sla1<-gen.data(sla1_notrans,transformation_template,n=NA,sn=NA, zero=0, t0=t0_abp)
print("gen sla1ok")
...
#all_haploid_2021 using the abp1mch sc alignments for sla1
...
myplot(abpmch_rvsdel2_sla1[,"t"],abpmch_rvsdel2_sla1[,"n"],abpmch_rvsdel2_sla1[,"t.err"],abpmch_rvsdel2_sla1[,"n.err"],line.col="#ccddee",hold_on=TRUE,line.lwd=3,deltat=0.45)
legend("topleft",c("abp1mch 1xRvs", "abp1mch 2xRvs","abp1mch 2xBAR", "abp1mch 1xBAR", "abp1mch rvsdel"),lty=1,col=c("#000000", "#CC0066", "#660099","#66cc99","#ccddee"),bty='n', cex=0.75)
